...
// Nasty path: if you run the runnable class without changing any values, several times in a row, will it give you errors?
public class HibernateRunner {
    ...
    private void addNewUsers() {
         ...
         */
        // Nasty path: see what happens when you enter a null for a new username or password.
         ...
         */
        // Nasty path: try different methods here (merge). See if it saves both users.
    ...
    private void modifyUser() {
         ...
         */
        // Nasty path: Use a username that does not exist - lee is what I'm referencing here, which is happy.
        // Nasty path: Try using null instead of lee.
    ...
    private void addSharedPhoneNumber() {
         ...
         */
        // Nasty path: try using something different than the originally-selected user (lee) from the select statement
        // under the modifyUser method.
